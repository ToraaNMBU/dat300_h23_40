...
if substring in current_directory:
    ...
    CSV_PATH = '/mnt/users/dat300-h23-40/ca3/models/submission.csv'
    batch_size = 128
    epochs = 40
else:
    MODEL_PATH = "../models/model.keras"
    PICTURE_PATH = "../models/model.png"
    CSV_PATH = '../models/submission.csv'
...
submissionDF.to_csv(CSV_PATH, index=False)        # Remember to store the dataframe to csv without the nameless index column.
